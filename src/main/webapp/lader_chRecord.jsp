                        ...
                        <div class="white-box">
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tbody>
	                                    <c:forEach items="${chrecords }" var="ch" varStatus="i">
	                                    
	                                    	<tr>
	                                    		<td>${i.count }</td>
	                                    		<td>${ch.student.stuName }</td>
	                                    		<td>${ch.chReTime}</td>
	                                    		<td>
		                                    		<c:choose>
		                                    			<c:when test="${ch.chId==1 }">正常</c:when>
		                                    			<c:when test="${ch.chId==2 }">旷课</c:when>
		                                    			<c:when test="${ch.chId==3 }">请假</c:when>
		                                    			<c:when test="${ch.chId==4 }">迟到</c:when>
		                                    		</c:choose>
	                                    		</td>
	                                    	</tr>
