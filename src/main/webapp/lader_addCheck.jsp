                        ...
                        <div class="white-box">
                            <form class="form-horizontal form-material">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-12">考勤</label>
                                    <div class="col-sm-12">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="white-box">
                            <form class="form-horizontal form-material" action="saveCheckRecord.action" method="post">
                            	<!--考勤-->
                                <div class="form-group">
                                    <label class="col-sm-12">考勤</label>
                                    <div class="col-sm-12">
                                        <select class="form-control form-control-line" name="check.chId">
                                        
                                        	<c:forEach items="${checks }" var="check">
                                            	<option value="${check.chId }">${check.chName }</option>
                                        	</c:forEach>
